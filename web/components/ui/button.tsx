  ...
  "group/button inline-flex shrink-0 cursor-pointer items-center justify-center rounded-lg border bg-clip-padding whitespace-nowrap transition-all outline-none select-none focus-visible:border-ring focus-visible:ring-3 focus-visible:ring-ring/50 active:not-aria-[haspopup]:translate-y-px disabled:pointer-events-none disabled:opacity-50 aria-invalid:border-destructive aria-invalid:ring-3 aria-invalid:ring-destructive/20 motion-reduce:transition-none motion-reduce:active:translate-y-0 dark:aria-invalid:border-destructive/50 dark:aria-invalid:ring-destructive/40 [&_svg]:pointer-events-none [&_svg]:shrink-0 [&_svg:not([class*='size-'])]:size-4",
  {
    variants: {
      variant: {
        ...
        plain:
          "border-transparent bg-transparent hover:bg-transparent active:not-aria-[haspopup]:translate-y-0 aria-expanded:bg-transparent dark:hover:bg-transparent",
        surface:
          "border-border bg-card text-card-foreground shadow-sm hover:bg-muted/50 active:not-aria-[haspopup]:translate-y-0 aria-expanded:bg-muted/50",
        destructive:
      ...
      size: {
        ...
        surface:
          "type-supporting-body h-auto w-full justify-start gap-3 rounded-xl p-4 text-left whitespace-normal",

...
function DrawerDescription({
  ...
  return (
    <DrawerPrimitive.Description
      ...
      className={cn(
        "type-supporting-body text-balance text-muted-foreground",
        className
      )}
      {...props}
    />

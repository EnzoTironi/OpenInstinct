...
| ------------------------ | -------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| First contact            | Message the assistant, receive a useful response immediately, learn how to connect tools only when useful      | An unlinked messenger receives the sign-in instruction and no account exists before the confirmed link; group messages from unlinked senders create nothing; abuse limits apply before expensive work |

 ...
 */
export class CodeCompilationError extends Data.TaggedError(
 ...
 */
export class SandboxRuntimeError extends Data.TaggedError(
  "SandboxRuntimeError"
)<{
  readonly runtime: string;
  readonly message: string;
 ...
 */
export class SandboxHostTimeoutError extends Data.TaggedError(
